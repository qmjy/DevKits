...
public class HotKeySettingsAction extends BaseAction {
    ...
    protected Component drawCenterPanel() {
        ...
        builder.append(DKSystemUIUtil.getLocaleString("SETTINGS_SYS_SETTINGS_HOTKEY_NEW_TASK_LAB"), new JTextField("Ctrl + T"), new JButton("清空"));
        builder.append(DKSystemUIUtil.getLocaleString("SETTINGS_SYS_SETTINGS_HOTKEY_SCREENSHOT"), new JTextField("Ctrl + Alt + A"), new JButton("清空"));

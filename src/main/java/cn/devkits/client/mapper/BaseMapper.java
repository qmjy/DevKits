...
public interface BaseMapper {
     ...
     * 创建邮箱配置表
     */
    @Update({"CREATE TABLE IF NOT EXISTS devkits_email_list(id INTEGER PRIMARY KEY AUTOINCREMENT, host TEXT NOT NULL, port INTEGER, email TEXT NOT NUll, " +
            "account TEXT, pwd TEXT NOT NULL, tls NUMERIC DEFAULT 0, defaultServer NUMERIC DEFAULT 0, createTime TimeStamp NOT NULL DEFAULT (datetime('now'," +
            "'localtime')))"})

 ...
 * @since 2021/10/31
 */
public class CameraFrame extends JFrame implements WebcamListener, WindowListener, Thread.UncaughtExceptionHandler, ItemListener,
    ...
    public CameraFrame() {
        ...
        webcam.addWebcamListener(CameraFrame.this);
